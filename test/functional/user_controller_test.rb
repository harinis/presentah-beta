...
class UserControllerTest < ActionController::TestCase
    ...
    def test_user_cannot_view_pages_on_the_site_without_signing_in
        [:post_presentation, :review_presentations, :presentation, :rate_presentation,
                :search, :sign_out].each do |action|
            get action
            assert_redirected_to :action => :index
        end
    end
